...
@Component({
  selector: 'app-todas-camaras',
  standalone: true,
  imports: [CommonModule, RouterLink, FormsModule, ReactiveFormsModule],
  templateUrl: './todas-camaras.html',
  styleUrl: './todas-camaras.css'
})
export class TodasCamaras implements OnInit, OnDestroy, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    // Forzar modo lista por defecto
    this.viewMode.set('list');

    // Cargar la lista global de hosts
